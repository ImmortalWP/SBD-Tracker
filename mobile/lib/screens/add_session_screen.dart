              ...
              children: [
                Container(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(fontSize: 10, fontWeight: FontWeight.w700, color: catColor, letterSpacing: 0.5),
                  ),
                ),
                const Spacer(),
                if (_exercises.length > 1)
                  IconButton(
                    icon: const Icon(Icons.close, size: 18, color: AppTheme.text500),
                ...
                child: Row(
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: sets.length > 1
                          ? IconButton(
                              icon: const Icon(Icons.remove_circle_outline, size: 18, color: AppTheme.text500),
                              onPressed: () => setState(() => sets.removeAt(sIdx)),
                              constraints: const BoxConstraints(),
                              padding: EdgeInsets.zero,
                            )
                          : const SizedBox(),
